...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230513063427_ChangeAuditableColumnsToRequiredInOpinionsTable")]
    partial class ChangeAuditableColumnsToRequiredInOpinionsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.BeerStyle", b =>
                {
                    ...
                    b.Property<Guid>("PrimaryBeerStyleId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("PrimaryBeerStyleId");
            ...
            modelBuilder.Entity("Domain.Entities.PrimaryBeerStyle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.BeerStyle", b =>
                {
                    b.HasOne("Domain.Entities.PrimaryBeerStyle", "PrimaryBeerStyle")
                        .WithMany("BeerStyles")
                        .HasForeignKey("PrimaryBeerStyleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PrimaryBeerStyle");
                });
