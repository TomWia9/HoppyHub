...
INSERT INTO Beers (Id, Name, AlcoholByVolume, Blg, Plato, Ibu, Description, BreweryId, BeerStyleId, Composition)
VALUES (NEWID(), 'West Coast Punch', 7.2, 16, 4.04, 70, 'Intensely hopped with citrus and pine notes',
        @BrowarStuMostówId, @WestCoastIPAStyleId,
        'Pale ale malt, caramel malt, Cascade hops, Simcoe hops, Chinook hops'),
       (NEWID(), 'Hazy Memory', 6.8, 16, 4.04, 45, 'Juicy with tropical fruit flavors and low bitterness',
        @BrowarStuMostówId, @NewEnglandIPAStyleId,
        'Pale ale malt, wheat malt, oats, Citra hops, Mosaic hops, Galaxy hops'),
       (NEWID(), 'Double Dry Hop Mosaic', 8.5, 18, 4.56, 80, 'Big and bold with resinous pine and grapefruit flavors',
        @BrowarStuMostówId, @DoubleIPAStyleId, 'Pale ale malt, crystal malt, Munich malt, Mosaic hops'),
       (NEWID(), 'Belgian Black Diamond', 7.5, 17, 4.32, 50, 'Spicy and fruity with a dry finish', @BrowarStuMostówId,
        @BelgianIPAStyleId, 'Pilsner malt, wheat malt, caramel malt, Belgian yeast, Saaz hops, Styrian Goldings hops'),
       (NEWID(), 'Cocoa Muffin', 6.0, 14, 3.52, 30, 'Smooth and creamy with chocolate and coffee flavors',
...
INSERT INTO Beers (Id, Name, AlcoholByVolume, Blg, Plato, Ibu, Description, BreweryId, BeerStyleId, Composition)
VALUES (NEWID(), 'West Coast Warrior', 6.5, 16, 4.0, 60, 'Classic West Coast IPA', @BrowarPintaId, @WestCoastIPAStyleId,
        'Water, malted barley, hops, yeast'),
       (NEWID(), 'New England Haze', 6.2, 14, 3.5, 40, 'Hazy and juicy IPA', @BrowarPintaId, @NewEnglandIPAStyleId,
        'Water, malted barley, wheat, oats, hops, yeast'),
       (NEWID(), 'Double Dragon', 8.0, 18, 4.5, 90, 'Double IPA with citrus and pine notes', @BrowarPintaId,
        @DoubleIPAStyleId, 'Water, malted barley, hops, yeast'),
       (NEWID(), 'Black Mamba', 7.0, 18, 4.5, 70, 'Black IPA with roasted malt and tropical fruit notes',
        @BrowarPintaId, @BlackIPAStyleId, 'Water, malted barley, roasted barley, hops, yeast'),
       (NEWID(), 'Belgian White Knight', 5.5, 12, 3.0, 20, 'Belgian-style IPA with coriander and orange peel',
...
INSERT INTO Beers (Id, Name, AlcoholByVolume, Blg, Plato, Ibu, Description, BreweryId, BeerStyleId, Composition)
VALUES (NEWID(), 'Artezan Summer Breeze', 4.7, 11.5, 2.9, 25,
       ...
       (NEWID(), 'Artezan Nutty Brown', 5.0, 13.0, 3.3, 25,
...
INSERT INTO Beers (Id, Name, AlcoholByVolume, Blg, Plato, Ibu, Description, BreweryId, BeerStyleId, Composition)
VALUES (NEWID(), 'Three Brothers Dry Stout', 4.5, 12, 3.2, 30,
       ...
       (NEWID(), 'Golden Hops German Pilsner', 5.0, 11, 2.8, 35,
       ...
       (NEWID(), 'Brooklyn Bridge American Porter', 6.5, 15, 3.8, 45,
...
INSERT INTO Beers (Id, Name, AlcoholByVolume, Blg, Plato, Ibu, Description, BreweryId, BeerStyleId, Composition)
VALUES (NEWID(), 'Dark Descent', 11.0, 25.0, 10.5, 90, 'Imperial stout brewed with cocoa nibs and vanilla',
        @BrowarNepomucenId, @ImperialStoutStyleId, 'water, barley malt, oats, hops, yeast, cocoa nibs, vanilla'),
       (NEWID(), 'Pils Italiano', 5.5, 12.0, 4.8, 35, 'Crisp and refreshing Italian-style pilsner', @BrowarNepomucenId,
        @ItalianPilsnerStyleId, 'water, barley malt, hops, yeast'),
       (NEWID(), 'Wheat Walker', 4.8, 12.5, 5.0, 20, 'American wheat beer brewed with citra and amarillo hops',
        @BrowarNepomucenId, @AmericanWheatStyleId, 'water, wheat malt, barley malt, hops, yeast'),
       (NEWID(), 'Kristallklar', 5.0, 11.5, 4.6, 18, 'Crisp and clear German-style kristallweizen', @BrowarNepomucenId,
        @KristallweizenStyleId, 'water, wheat malt, barley malt, hops, yeast'),
       (NEWID(), 'Fruitful Dubbel', 7.0, 18.5, 7.5, 30, 'Belgian-style dubbel brewed with cherries and plums',
...
INSERT INTO Beers (Id, Name, AlcoholByVolume, Blg, Plato, Ibu, Description, BreweryId, BeerStyleId, Composition)
VALUES (NEWID(), 'Maryensztadt Dubbel IPA', 7.5, 18, 4.5, 80, N'Double IPA z dodatkiem suszonych owoców',
        @BrowarMaryensztadtId, @DubbelIPAStyleId,
        N'Woda, słód jęczmienny, chmiel, drożdże'),
       (NEWID(), 'Maryensztadt Mild Ale', 3.5, 12, 3, 25, N'Lekkie i łatwe w piciu, z nutą karmelu',
        @BrowarMaryensztadtId, @MildAleStyleId,
        N'Woda, słód jęczmienny, chmiel, drożdże'),
       (NEWID(), 'Maryensztadt American Wild Ale', 6, 16, 4, 45, N'Kwaśne i dzikie piwo, lekko owocowe',
        @BrowarMaryensztadtId, @AmericanWildAleStyleId,
        N'Woda, słód jęczmienny, chmiel, drożdże, bakterie mlekowe'),
       (NEWID(), 'Maryensztadt American Hefeweizen', 5, 14, 3.5, 20,
        N'Klasyczne hefeweizen z dodatkiem amerykańskiego chmielu', @BrowarMaryensztadtId, @AmericanHefeweizenStyleId,
        N'Woda, słód pszeniczny, chmiel, drożdże'),
       (NEWID(), 'Maryensztadt Smoked Porter', 6.5, 15, 3.8, 40, N'Piwo o smaku wędzonego sera, idealne do mięs',
...
INSERT INTO Beers (Id, Name, AlcoholByVolume, Blg, Plato, Ibu, Description, BreweryId, BeerStyleId, Composition)
VALUES (NEWID(), 'Lambic', 5.0, 12.0, 3.0, 10,
       ...
       (NEWID(), 'Flanders Red Ale', 6.0, 14.0, 3.5, 20,
       ...
       (NEWID(), 'Dunkelweizen', 5.5, 12.5, 3.2, 15,
       ...
       (NEWID(), 'English Porter', 6.2, 13.5, 3.4, 25,
       ...
       (NEWID(), 'English Pale Ale', 5.0, 11.0, 2.8, 30,
...
INSERT INTO Beers (Id, Name, AlcoholByVolume, Blg, Plato, Ibu, Description, BreweryId, BeerStyleId, Composition)
VALUES (NEWID(), 'Foreign Extra Stout', 7.5, 18.5, 7.5, 50,
       ...
       (NEWID(), 'Mexican Pilsner', 5.2, 12, 4.8, 20,
       ...
       (NEWID(), 'Belgian Pale Ale', 6.5, 14, 5.5, 35,
       ...
       (NEWID(), 'Robust Porter', 6.0, 15.5, 6.0, 40,
...
INSERT INTO Beers (Id, Name, AlcoholByVolume, Blg, Plato, Ibu, Description, BreweryId, BeerStyleId, Composition)
VALUES (NEWID(), 'Smoked Dubbel', 8.5, 18.2, 4.6, 25, 'Belgian Dubbel with smoky notes', @BrowarProfesjaId,
        @SmokedDubbelStyleId, 'water, malt, hops, yeast, smoked malt'),
       (NEWID(), 'American Brown Ale', 5.5, 14, 3.5, 40, 'Rich and malty with a hoppy finish', @BrowarProfesjaId,
        @AmericanBrownAleStyleId, 'water, malt, hops, yeast'),
       (NEWID(), 'Session Pale Ale', 4.5, 12.5, 3.2, 35, 'Easy drinking pale ale with a light body and low bitterness',
        @BrowarProfesjaId, @SessionPaleAleStyleId, 'water, malt, hops, yeast'),
       (NEWID(), 'Belgian Witbier', 4.2, 11.5, 2.9, 20, 'Light and refreshing with notes of orange and coriander',
        @BrowarProfesjaId, @BelgianWitbierStyleId, 'water, malt, hops, yeast, wheat, orange peel, coriander'),
       (NEWID(), 'Extra Pale Ale', 5.8, 14, 3.5, 50, 'Hoppy and aromatic with a clean finish', @BrowarProfesjaId,
        @ExtraPaleAleStyleId, 'water, malt, hops, yeast');

-- Spółdzielczy brewery
DECLARE @BrowarSpółdzielczyId NVARCHAR(36) = '155197e5-24f8-4861-8b3e-c6c91247eacf';

INSERT INTO Beers (Id, Name, AlcoholByVolume, Blg, Plato, Ibu, Description, BreweryId, BeerStyleId, Composition)
VALUES (NEWID(), 'Weizenbock', 8.5, 18, 20, 30, 'Weizenbock to mocniejsza wersja niemieckiego pszenicznego piwa.',
        @BrowarSpółdzielczyId, @WeizenbockStyleId,
        N'Woda, słód pszeniczny, słód jęczmienny, chmiel, drożdże'),
       (NEWID(), 'Belgian Dubbel', 7.0, 16, 18, 25, N'Belgijskie piwo o bogatej słodowości i nutach ciemnych owoców.',
        @BrowarSpółdzielczyId, @BelgianDubbelStyleId,
        N'Woda, słód jęczmienny, chmiel, drożdże'),
       (NEWID(), 'Northern English Brown Ale', 4.5, 12, 14, 20,
        ...
        N'Woda, słód jęczmienny, chmiel, drożdże'),
       (NEWID(), 'Berliner Weisse', 3.0, 8, 9, 5, N'Lekkie, kwaśne niemieckie piwo pszeniczne.', @BrowarSpółdzielczyId,
        @BerlinerWeisseStyleId,
        N'Woda, słód pszeniczny, chmiel, drożdże, bakterie fermentacji mlekowej'),
       (NEWID(), 'German Hefeweizen', 5.0, 12, 14, 15,
        ...
        N'Woda, słód pszeniczny, słód jęczmienny, chmiel, drożdże'),
       (NEWID(), 'Leffe Brune', 6.5, 17, 17, 20, N'Belgian Dubbel ale brewed by Spółdzielczy brewery.',
