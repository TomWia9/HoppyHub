...
public class CreateBreweryCommandValidatorTests
{
    ...
    /// </summary>
    [Fact]
    public async Task CreateBreweryCommand_ShouldNotHaveValidationErrorForDescription_WhenDescriptionIsValid()
    {
        // Arrange
    ...
    /// </summary>
    [Fact]
    public async Task CreateBreweryCommand_ShouldHaveValidationErrorForDescription_WhenDescriptionExceedsMaximumLength()
    {
        // Arrange
        var command = new CreateBreweryCommand()
        {
    ...
    /// </summary>
    [Fact]
    public async Task CreateBreweryCommand_ShouldHaveValidationErrorForDescription_WhenDescriptionIsEmpty()
    {
        // Arrange
        var command = new CreateBreweryCommand()
        {
    ...
    /// </summary>
    [Fact]
    public async Task CreateBreweryCommand_ShouldNotHaveValidationErrorForFoundationYear_WhenFoundationYearIsValid()
    {
        // Arrange
        var command = new CreateBreweryCommand
        {
    ...
    [InlineData(-1)]
    [InlineData(9999)]
    public async Task CreateBreweryCommand_ShouldHaveValidationErrorForFoundationYear_WhenFoundationYearIsOutOfRange(
        int foundationYear)
    {
        // Arrange
        var command = new CreateBreweryCommand
    ...
    /// </summary>
    [Fact]
    public async Task CreateBreweryCommand_ShouldNotHaveValidationErrorForWebsiteUrl_WhenWebsiteUrlIsValid()
    {
        // Arrange
        var command = new CreateBreweryCommand
        {
    ...
    /// </summary>
    [Fact]
    public async Task CreateBreweryCommand_ShouldHaveValidationErrorForWebsiteUrl_WhenWebsiteUrlExceedsMaximumLength()
    {
        // Arrange
        var command = new CreateBreweryCommand
        {
    ...
    /// </summary>
    [Fact]
    public async Task CreateBreweryCommand_ShouldHaveValidationErrorForWebsiteUrl_WhenWebsiteUrlIsInvalid()
    {
        // Arrange
        var command = new CreateBreweryCommand
        {
    ...
    /// </summary>
    [Fact]
    public async Task CreateBreweryCommand_ShouldNotHaveValidationErrorForStreet_WhenStreetIsValid()
    {
        // Arrange
        var command = new CreateBreweryCommand()
        {
    ...
    /// </summary>
    [Fact]
    public async Task CreateBreweryCommand_ShouldHaveValidationErrorForStreet_WhenStreetExceedsMaximumLength()
    {
        // Arrange
        var command = new CreateBreweryCommand()
        {
    ...
    /// </summary>
    [Fact]
    public async Task CreateBreweryCommand_ShouldHaveValidationErrorForStreet_WhenStreetIsEmpty()
    {
        // Arrange
        var command = new CreateBreweryCommand()
        {
    ...
    /// </summary>
    [Fact]
    public async Task CreateBreweryCommand_ShouldNotHaveValidationErrorForNumber_WhenNumberIsValid()
    {
        // Arrange
        var command = new CreateBreweryCommand()
        {
    ...
    /// </summary>
    [Fact]
    public async Task CreateBreweryCommand_ShouldHaveValidationErrorForNumber_WhenNumberExceedsMaximumLength()
    {
        // Arrange
        var command = new CreateBreweryCommand()
        {
    ...
    /// </summary>
    [Fact]
    public async Task CreateBreweryCommand_ShouldHaveValidationErrorForNumber_WhenNumberIsEmpty()
    {
        // Arrange
        var command = new CreateBreweryCommand()
        {
    ...
    /// </summary>
    [Fact]
    public async Task CreateBreweryCommand_ShouldNotHaveValidationErrorForPostCode_WhenPostCodeIsValid()
    {
        // Arrange
        var command = new CreateBreweryCommand()
        {
    ...
    /// </summary>
    [Fact]
    public async Task CreateBreweryCommand_ShouldHaveValidationErrorForPostCode_WhenPostCodeIsEmpty()
    {
        // Arrange
        var command = new CreateBreweryCommand()
        {
    ...
    [InlineData("123456")]
    [InlineData("123-56")]
    public async Task CreateBreweryCommand_ShouldHaveValidationErrorForPostCode_WhenPostCodeHasInvalidFormat(
        string postCode)
    {
        // Arrange
        var command = new CreateBreweryCommand()
    ...
    /// </summary>
    [Fact]
    public async Task CreateBreweryCommand_ShouldNotHaveValidationErrorForCity_WhenCityIsValid()
    {
        // Arrange
        var command = new CreateBreweryCommand()
        {
    ...
    /// </summary>
    [Fact]
    public async Task CreateBreweryCommand_ShouldHaveValidationErrorForCity_WhenCityExceedsMaximumLength()
    {
        // Arrange
        var command = new CreateBreweryCommand()
        {
    ...
    /// </summary>
    [Fact]
    public async Task CreateBreweryCommand_ShouldHaveValidationErrorForCity_WhenCityIsEmpty()
    {
        // Arrange
        var command = new CreateBreweryCommand()
        {
    ...
    /// </summary>
    [Fact]
    public async Task CreateBreweryCommand_ShouldNotHaveValidationErrorForState_WhenStateIsValid()
    {
        // Arrange
        var command = new CreateBreweryCommand()
        {
    ...
    /// </summary>
    [Fact]
    public async Task CreateBreweryCommand_ShouldHaveValidationErrorForState_WhenStateExceedsMaximumLength()
    {
        // Arrange
        var command = new CreateBreweryCommand()
        {
    ...
    /// </summary>
    [Fact]
    public async Task CreateBreweryCommand_ShouldHaveValidationErrorForState_WhenStateIsEmpty()
    {
        // Arrange
        var command = new CreateBreweryCommand()
        {
    ...
    /// </summary>
    [Fact]
    public async Task CreateBreweryCommand_ShouldNotHaveValidationErrorForCountry_WhenCountryIsValid()
    {
        // Arrange
        var command = new CreateBreweryCommand()
        {
    ...
    /// </summary>
    [Fact]
    public async Task CreateBreweryCommand_ShouldHaveValidationErrorForCountry_WhenCountryExceedsMaximumLength()
    {
        // Arrange
        var command = new CreateBreweryCommand()
        {
    ...
    /// </summary>
    [Fact]
    public async Task CreateBreweryCommand_ShouldHaveValidationErrorForCountry_WhenCountryIsEmpty()
    {
        // Arrange
        var command = new CreateBreweryCommand()
        {
    ...
    /// </summary>
    [Fact]
    public async Task CreateBreweryCommand_ShouldNotHaveValidationErrorForName_WhenNameIsValid()
    {
        // Arrange
        var command = new CreateBreweryCommand()
        {
    ...
    /// </summary>
    [Fact]
    public async Task CreateBreweryCommand_ShouldHaveValidationErrorForName_WhenNameExceedsMaximumLength()
    {
        // Arrange
        var command = new CreateBreweryCommand()
        {
    ...
    /// </summary>
    [Fact]
    public async Task CreateBreweryCommand_ShouldHaveValidationErrorForName_WhenNameIsEmpty()
    {
        // Arrange
        var command = new CreateBreweryCommand()
        {
