...
public class MappingExtensionsTests
{
    ...
    public void ToPaginatedList_ShouldCreatePaginatedList()
    {
        ...
        var source = Enumerable.Range(1, count).Select(x => new TestObject { Id = x }).ToList();
        ...
        result[0].Should().BeEquivalentTo(new TestObject { Id = 6 });
        result[4].Should().BeEquivalentTo(new TestObject { Id = 10 });
    }
}