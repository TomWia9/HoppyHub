...
public class UserConfigurationTests
{
    ...
    public void UserConfiguration_ShouldConfigureEntityCorrectly()
    {
        ...
        var opinionsNavigation = entity.FindNavigation(nameof(User.Favorites))!;
        ...
        opinionsNavigation.ForeignKey.Properties.Should().Contain(x => x.Name == nameof(Favorite.CreatedBy));
    }
}